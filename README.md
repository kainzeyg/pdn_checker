Вот пример содержательного и оформленного `README.md` файла для вашего Go-приложения по анализу базы данных на наличие потенциальных персональных данных (ПДн):
